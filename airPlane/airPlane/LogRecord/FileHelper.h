...
#define MKDIR(a) mkdir((a),0755)
  ...
  class FileHelper
  {
    public:
      static bool
      save(const std::string filename,std::string& content)
      {
	...
	return true;
      ...
      static bool
      open(const std::string filename,std::string& content)
      {
	...
	return true;
      ...
      static bool
      open(const std::string file_name,std::vector<std::string>& lines)
      {
